...
namespace sdlk
{
	...
	{
		std::vector<GlyphGeometry> m_glyphs_storage{};
		FontGeometry m_font_geometry{ &m_glyphs_storage };
		...
		auto configure(size_t start_index) -> void;
	...
	public:
		...
		[[nodiscard]] auto get(const char32_t &c) const
